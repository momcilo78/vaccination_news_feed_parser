...
class TestBaseArticleParser(object):
    ...
    def test_parse_sentence(self, capsys, parser, sentences):
        for sentence in sentences:
            result = parser.parse_sentence(sentence['text'])
            assert result['total_number_of_vaccinations'] == sentence['total_number_of_vaccinations']
            assert result['fully_vaccinated'] == sentence['fully_vaccinated']
